export const de = {
  hero: {
    ...
    subtitle: 'Padel, Tennis, Golf, Pickle-Ball — an drei Standorten in Basel. Anfrage in 3 Minuten.',
  ...
  steps: {
    ...
    attendees: {
      ...
      count: 'Personenzahl', ageGroup: 'Altersgruppe',
      ageGroups: { kids: 'Kinder / Schüler', adults: 'Erwachsene', mixed: 'Gemischt' },
    ...
    confirmation: {
      title: 'Danke!',
      subtitle: 'Wir melden uns bei dir!',
