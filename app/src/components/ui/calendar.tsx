  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-3",
        month_caption: "grid grid-cols-[2rem_1fr_2rem] items-center h-8 mb-2",
        caption_label: "text-sm font-semibold text-white text-center col-start-2",
        nav: "contents",
        button_previous: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 p-0 bg-transparent border-white/20 text-white/70 hover:bg-white/10 hover:text-white col-start-1 justify-self-start",
        ),
        button_next: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 p-0 bg-transparent border-white/20 text-white/70 hover:bg-white/10 hover:text-white col-start-3 justify-self-end",
        ),
